...
#import "LivePackageController.h"
...
@interface LivePackageController () <UITableViewDataSource,UITableViewDelegate,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
...
@implementation LivePackageController
...
- (void) updateDataSource
{
    ...
    NSArray *array = [LiveManager instance].livePackages;
...
{
    RequestLivePackage *request = [RequestLivePackage new];
