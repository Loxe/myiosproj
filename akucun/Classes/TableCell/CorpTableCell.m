...
@implementation CorpTableCell

- (void) updateData
{
    CorpCellLayout *cellLayout = (CorpCellLayout *)self.cellLayout;
    ...
    NSString *logoUrl = cellLayout.model.corplogo;
...
{
    CorpCellLayout *layout = (CorpCellLayout *)self.cellLayout;
