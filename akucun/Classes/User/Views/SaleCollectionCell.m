...
- (void)updateUIWithTitle:(NSString *)price titleColor:(UIColor *)color {
...
- (UILabel *)priceLabel {
    if (_priceLabel == nil) {
        ...
        _priceLabel.font          = SYSTEMFONT(27);
