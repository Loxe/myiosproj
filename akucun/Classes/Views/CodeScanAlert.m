                        ...
                        scanHandler:(MMPopupItemHandler)scanHandler
{
    NSArray *items =@[
                      ...
                      MMItemMake(@"扫描", MMItemTypeHighlight, scanHandler),
                      MMItemMake(@"确定", MMItemTypeHighlight, nil)
                      ];
    return [self initWithTitle:title detail:detail items:items inputPlaceholder:inputPlaceholder inputHandler:inputHandler scanHandler:scanHandler];
}
...
//        __block UIButton *secondButton = nil;
//        __block UIButton *lastButton   = nil;
        CGFloat btnW = config.width / 3;
...
//                lastButton = btn;
                make.top.bottom.equalTo(self.buttonView);
                make.left.equalTo(self.buttonView).offset(i*btnW);
                make.height.mas_equalTo(config.buttonHeight);
...
- (void)actionButton:(UIButton*)btn
{
    ...
    if ( self.inputHandler && (btn.tag==2) )
    {
