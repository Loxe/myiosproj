...
//        _scrollview.backgroundColor = JXColorWithRGB(250, 250, 250);
        ...
        _pageControl.currentPageIndicatorTintColor = [UIColor grayColor]; // 修改21
        _pageControl.pageIndicatorTintColor = [UIColor lightGrayColor]; // 修改22
        _emotionRow = 3;
        _emotionCol = 7;
...
//                                    itemHeight - 10);
    _pageControl.frame = CGRectMake(0, (maxRow - 1) * itemHeight + 10, CGRectGetWidth(self.frame),
                                    itemHeight - 10); // 修改23
