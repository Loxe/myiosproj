...
#import "IPadCameraFrontController.h"
...
@interface IPadCameraFrontController ()
...
@property(nonatomic, strong) LHSIDCardScaningView *preview;

@end

@implementation IPadCameraFrontController
...
- (void)prepareSubView {
    self.preview = [[LHSIDCardScaningView alloc] initWithFrame:self.view.frame];
