...
@implementation IDCardBackScaningView
{
...
-(void)addScaningWindow {
    ...
    CGFloat facePathWidth;
    CGFloat facePathHeight;
    if (isPad) {
        facePathWidth = 150;
        facePathHeight = facePathWidth * 0.812;
        self.facePathRect = (CGRect){CGRectGetMaxX(rect)-facePathWidth+45,CGRectGetMaxY(rect) - facePathHeight-306.5,facePathWidth-60,facePathHeight-60};
    } else {
        if (iPhoneX) {
            facePathWidth = 150;
            facePathHeight = facePathWidth * 0.812;
            self.facePathRect = (CGRect){CGRectGetMaxX(rect)-facePathWidth+35,CGRectGetMaxY(rect) - facePathHeight-306.5,facePathWidth-60,facePathHeight-60};
        } else if (iPhone6Plusor6sPlusor7Plus) {
            facePathWidth = 160;
            facePathHeight = facePathWidth * 0.812;
            self.facePathRect = (CGRect){CGRectGetMaxX(rect)-facePathWidth+35,CGRectGetMaxY(rect) - facePathHeight-302,facePathWidth-60,facePathHeight-60};
        } else if (iPhone6or6sor7) {
            facePathWidth = 150;
            facePathHeight = facePathWidth * 0.812;
            self.facePathRect = (CGRect){CGRectGetMaxX(rect)-facePathWidth+35,CGRectGetMaxY(rect) - facePathHeight-270.5,facePathWidth-60,facePathHeight-60};
        } else {//iPhone5or5cor5sorSE
            facePathWidth = 125;
            facePathHeight = facePathWidth * 0.812;
            self.facePathRect = (CGRect){CGRectGetMaxX(rect)-facePathWidth+35,CGRectGetMaxY(rect) - facePathHeight-240,facePathWidth-60,facePathHeight-60};
        }
    }
...
//    [self addTipLabelWithText:@"将身份证国徽面置于此区域内，四角对齐，静候2秒扫描" center:center];
    [self addTipLabelWithText:@"将身份证国徽面置于此区域内，四角对齐,点击按钮" center:center];
    ...
    headIV.image = [UIImage imageNamed:@"idcard_second_head"];
...
//        facePathWidth = 150;
//        facePathHeight = facePathWidth * 0.812;
//        lineRect = (CGRect){CGRectGetMaxX(rect)-facePathWidth+20,CGRectGetMaxY(rect) - facePathHeight-320,facePathWidth-40,facePathHeight-32};
//    } else if (iPhone6Plusor6sPlusor7Plus) {
//        facePathWidth = 160;
//        facePathHeight = facePathWidth * 0.812;
//        // 人像提示框，要比国徽的大--上下移调x(加上减下), 左右移调y（加右减左）,宽和高也是反的
//        lineRect = (CGRect){CGRectGetMaxX(rect)-facePathWidth+20,CGRectGetMaxY(rect) - facePathHeight-317,facePathWidth-40,facePathHeight-30};
//
//    } else if (iPhone6or6sor7) {
//
//        facePathWidth = 150;
//        facePathHeight = facePathWidth * 0.812;
//        lineRect = (CGRect){CGRectGetMaxX(rect)-facePathWidth+20,CGRectGetMaxY(rect) - facePathHeight-285,facePathWidth-40,facePathHeight-30};
//
//    } else {//iPhone5or5cor5sorSE
//        facePathWidth = 125;
//        facePathHeight = facePathWidth * 0.812;
//        lineRect = (CGRect){CGRectGetMaxX(rect)-facePathWidth+20,CGRectGetMaxY(rect) - facePathHeight-240,facePathWidth-40,facePathHeight-30};
//    }
//
//    UIBezierPath *facePath = [UIBezierPath bezierPathWithRect:lineRect];
