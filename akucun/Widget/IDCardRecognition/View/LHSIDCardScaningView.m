...
-(void)addScaningWindow {
    ...
    self.facePathRect = (CGRect){CGRectGetMaxX(rect) - facePathWidth - 45,CGRectGetMaxY(rect) - facePathHeight - 45,facePathWidth,facePathHeight};
    
    // 提示标签
    CGPoint center = self.center;
    center.x = CGRectGetMaxX(_IDCardScanningWindowLayer.frame) + 20;
    NSString *text = isPad ? @"将身份证人像面置于此区域内，四角对齐，点击按钮" : @"将身份证人像面置于此区域内，四角对齐，扫描";
