...
{
    return [self initWithInputTitle:title detail:detail placeholder:inputPlaceholder keyboard:UIKeyboardTypeDefault handler:inputHandler];
}
                            ...
                            handler:(MMPopupInputHandler)inputHandler
{
    ...
    if (detail) {
        attrStr = [[NSAttributedString alloc] initWithString:detail];
    }
    return [self initWithTitle:title detail:attrStr content:content items:items inputPlaceholder:inputPlaceholder keyboard:UIKeyboardTypeDefault inputHandler:inputHandler];
}
                            ...
                            handler:(MMPopupInputHandler)inputHandler
{
    ...
    return [self initWithTitle:title detail:attrStr content:@"" items:items inputPlaceholder:inputPlaceholder keyboard:keyboardType inputHandler:inputHandler];
}
                         ...
                         items:(NSArray*)items
{
    ...
    return [self initWithTitle:title detail:attrStr content:@"" items:items inputPlaceholder:nil keyboard:0 inputHandler:nil];
}

- (instancetype) initWithTitle:(NSString*)title
                    attrDetail:(NSAttributedString*)detail
                         items:(NSArray*)items
{
    return [self initWithTitle:title detail:detail content:@"" items:items inputPlaceholder:nil keyboard:0 inputHandler:nil];
}
