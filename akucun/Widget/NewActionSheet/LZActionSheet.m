...
#define LZ_ACTION_SHEET_TITLE_FONT  [UIFont systemFontOfSize:17.0f]
...
- (void)setupMainView {
    ...
    [darkView setBackgroundColor:RGBCOLOR(46, 49, 50)];
    ...
    [bottomView setBackgroundColor:COLOR_HEX(@"#f4f4ea")];
    ...
    if (self.title) {
        ...
        [label setTextColor:RGBCOLOR(111, 111, 111)];
    ...
    CGFloat cancelH = BUTTON_H + kSafeAreaBottomHeight;
    CGFloat btnY = BUTTON_H * (self.buttonTitles.count + (self.title ? 1 : 0)) + 5.0f;
    [cancelBtn setFrame:CGRectMake(0, btnY, SCREEN_SIZE.width, cancelH)];
    [bottomView addSubview:cancelBtn];
    
    cancelBtn.titleEdgeInsets = UIEdgeInsetsMake(0, 0, kSafeAreaBottomHeight*0.5, 0);
    CGFloat bottomH = (self.title ? BUTTON_H : 0) + BUTTON_H * self.buttonTitles.count + cancelH + 5.0f;
