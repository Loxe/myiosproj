...
- (void)setupSessionPreset:(NSString *)sessionPreset metadataObjectTypes:(NSArray *)metadataObjectTypes currentController:(UIViewController *)currentController {
    ...
    if (_session) {
        ...
        _videoPreviewLayer.frame = CGRectMake(0, 0, w, h);
    ...
    //metadataOutput.rectOfInterest = CGRectMake(0.05, 0.3, 0.7, 0.4);
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection {
    NSLog(@"SGQRCodeScanManager---didOutputMetadataObjects");
