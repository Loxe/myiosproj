...
#define kStarImage @"icon_star"

typedef void(^completeBlock)(CGFloat currentScore);

@interface SCStarRateView ()
...
-(void)createStarView
{
    ...
    self.foregroundStarView = [self createStarView:YES];
    self.backgroundStarView = [self createStarView:NO];
...
- (UIView *)createStarView:(BOOL)highlighted
{
    ...
    {
        UIImage *image = [IMAGENAMED(kStarImage) imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        UIImageView *imageView = [[UIImageView alloc] initWithImage:image];
        imageView.tintColor = highlighted ? COLOR_SELECTED : COLOR_TEXT_LIGHT;
...
- (void)layoutSubviews
{
    ...
    __weak SCStarRateView *weakSelf = self;
