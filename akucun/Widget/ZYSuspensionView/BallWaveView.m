...
//#define KWaveFillColor   [UIColor groupTableViewBackgroundColor] //填充颜色
//#define KWaveFrontColor  [UIColor colorWithRed:0/255.0 green:191/255.0 blue:255/255.0 alpha:1.0f] //前面波浪颜色
//#define KWaveBackColor   [UIColor colorWithRed:0/255.0 green:191/255.0 blue:255/255.0 alpha:0.4f] //后面波浪颜色
#define KWaveFillColor   RGBCOLOR(102, 102, 102) //填充颜色
#define KWaveFrontColor  RGBCOLOR(69, 151, 199) //前面波浪颜色
#define KWaveBackColor   COLOR_MAIN //后面波浪颜色

@interface BallWaveView ()
...
- (void)drawRect:(CGRect)rect {
    ...
    [KWaveFillColor setFill];
    [path fill];
    [path addClip];
    
    //绘制两个波形图
    [self drawWaveColor:KWaveFrontColor offsetx:0 offsety:0];
    [self drawWaveColor:KWaveBackColor offsetx:_wave_h_distance offsety:_wave_v_distance];
}
