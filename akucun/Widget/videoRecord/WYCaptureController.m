...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self setupUI];
    self.view.backgroundColor = wy_RGB(0x16161b);
...
- (void)prepareUI {
    ...
    _dotLabel.backgroundColor = wy_RGB(0xffc437);
    
    _leftBtn = [UIButton new];
    [_leftBtn setTitle:@"照片" forState:UIControlStateNormal];
    [_leftBtn setTitleColor:wy_RGB(0xfefeff) forState:UIControlStateNormal];
    _leftBtn.titleLabel.font = [UIFont systemFontOfSize:15.0];
    [_leftBtn addTarget:self action:@selector(leftBtnClick:) forControlEvents:UIControlEventTouchUpInside];
    _centerBtn = [UIButton new];
    [_centerBtn setTitleColor:wy_RGB(0x7ED321) forState:UIControlStateNormal];
    ...
    [_rightBtn setTitleColor:wy_RGB(0xfefeff) forState:UIControlStateNormal];
...
//    [_cameraBtn setImage:[UIImage imageNamed:@"button_camera_screen_click"] forState:UIControlStateHighlighted];
    ...
    [_importBtn setTitleColor:wy_RGB(0xfefeff) forState:UIControlStateNormal];
...
- (void)leftBtnClick:(UIButton *)btn {
    [_centerBtn setTitleColor:wy_RGB(0xfefeff) forState:UIControlStateNormal];
